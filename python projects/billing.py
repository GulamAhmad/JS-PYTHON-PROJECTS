...
def generate_bill():
    ...
    quantity=quantityVar.get()
    cost = costVar.get()
    conn = pymysql.connect(host="localhost", user="root", passwd="root123", db="billservice")
    cursor = conn.cursor()
...
#=================update bill data===========
def updateBillsData():
    for element in billsTV.get_children():
        billsTV.delete(element)
...
def loginWindow():
    titleLabel = Label(window,text="K&S Billing System",font="Arial 40",fg="green")
...
def mainwindow():
    ...
    titleLabel = Label(window,text="K&S Billing System",font="Arial 30",fg="green")
...
def itemAddWindow():
    ...
    titleLabel = Label(window,text="K&S Billing System", width=40,font="Arial 30",fg="green")
